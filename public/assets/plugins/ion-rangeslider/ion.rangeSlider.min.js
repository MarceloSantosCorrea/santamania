    ...
    r.prototype         = {
        ...
        pointerMove                  : function (a) {
            ...
            if (this.current_plugin === this.plugin_count && this.is_active) {
                ...
                if (g.contains(this.$cache.cont[0], a.target) || this.dragging) this.is_finish =
                    !0, this.callOnFinish();
                this.dragging = !1
            }
            ...
            var a = this.options, b = this.$cache, d = "number" === typeof a.from_min &&
                !isNaN(a.from_min), c                = "number" === typeof a.from_max && !isNaN(a.from_max),
        ...
        callOnFinish                 : function () {
            ...
            var b                                              =
                    this.options.min, d = this.options.max, c = b.toString().split(".")[1],
                e = d.toString().split(".")[1], f, l, g = 0, k = 0;
