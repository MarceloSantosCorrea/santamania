 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ChecklistTotal whereOutput($value)
 ...
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse whereProductId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse whereUpdatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\ProductWarehouse whereWarehouseId($value)
 */
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Sector whereActive($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Sector whereUid($value)
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Sector[] $checklistSectors
 * @property-read int|null $checklist_sectors_count
 ...
 * @property-read \App\Models\Product $product
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\ChecklistWarehouseQuantity[] $quantities
