                                        ...
                                        <div class="form-row align-items-center">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="product_id" id="product_id" class="form-control select2">
                                                        ...
                                                        @foreach($products as $product)
                                                            <option value="{{ $product->id }}" {{ isset(request()->product_id) && $product->id == request()->product_id ? 'selected="selected"': null }}>{{ $product->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="date_start" id="date_start" value="{{ isset(request()->date_start)? request()->date_start: '' }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="date_end" id="date_end" value="{{ isset(request()->date_end)? request()->date_end: '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
