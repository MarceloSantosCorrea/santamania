                        ...
                        <div class="card-box">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form class="form-horizontal" method="post" action="{{ route('web.checklist-product.store', [
                                        ...
                                        @if($warehouses)
                                            ...
                                            @foreach($warehouses as $warehouse)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="number" step="any" name="quantities[{{ $warehouse->id }}]" id="date" class="form-control" value="">
